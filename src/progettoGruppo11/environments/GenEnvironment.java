...
public class GenEnvironment<T> implements Environment<T> {
	...
	// Controlla per ciascuno scope la presenza della variabile
	 ...
	 *
	 * Controlla se la variabile definita con var è presente nello scope più annidato (viene visitata la hashMap).
	 * Se è presente in scope più esterni non vi sono problemi, in quanto
	 * una dichiarazione più interna sovrascrive quelle esterne.
	 */
